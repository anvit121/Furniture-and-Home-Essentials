...
<head>
    ...
    <title>Iconic Products-Cozy Space</title>
...
<body>
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
                <a href="iconic_products.php" class="breadcrumbs__link breadcrumbs__link--active">Iconic Products</a>
            </li>
        </ul>
        ...
        <div id="message"></div>
            ...
            <?php
                    include 'config.php';
                    $stmt = $con->prepare('SELECT * FROM iconic_products');
                    $stmt->execute();
