...
<body>
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
                <a href="Rooms/livingroom.php" class="breadcrumbs__link">Living Room</a>
            </li>
            <li class="breadcrumbs__item">
                <a href="lr_dinetable_products.php" class="breadcrumbs__link breadcrumbs__link--active">Products</a>
            </li>
        </ul>
        ...
        <div id="message"></div>
            ...
            <?php
                    include 'config.php';
                    $stmt = $con->prepare('SELECT * FROM living_diningtable');
                    $stmt->execute();
