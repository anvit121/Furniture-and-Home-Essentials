...
<body>
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
                <a href="" class="breadcrumbs__link">Rooms</a>
            </li>
            <li class="breadcrumbs__item">
                <a href="" class="breadcrumbs__link">Living Room</a>
            </li>
            <li class="breadcrumbs__item">
                <a href="" class="breadcrumbs__link breadcrumbs__link--active">Products</a>
            </li>
        </ul>
        ...
        <div id="message"></div>
            ...
            <?php
                    include 'config.php';
                    $stmt = $con->prepare('SELECT * FROM kitchen_storagebox');
                    $stmt->execute();
